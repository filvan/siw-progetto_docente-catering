...
public class IngredienteService {
	...
	@Transactional
	public void update(Long id, String nome, String origine, String descrizione) {
		this.ingredienteRepository.updateNomeAndOrigineAndDescrizioneById(id, nome, origine, descrizione);
	}
}